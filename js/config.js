...
// ============ Meshy 3D 生成配置 ============
        ...
        var creatures = [
            ...
            { id: 'xishui', name: '吸水兽', desc: '桥孔兽·好吞吐·蹲踞桥孔吐水', location: '正阳桥·桥洞券脸顶部', color: '#5B8C6B', image: 'https://zhongzhouxian-1413555799.cos.ap-guangzhou.myqcloud.com/assets/xishui_shou.png' },
        ...
        var colors = [{ id: 'zhusha', name: '朱砂红', hex: '#C45C5C', meaning: '辟邪纳福·热烈醒目', level: 'royal' }, { id: 'shiqing', name: '石青蓝', hex: '#4A7FB5', meaning: '矿物青色·沉静古雅', level: 'folk' }, { id: 'daiwa', name: '黛瓦灰', hex: '#6B7B8C', meaning: '城楼屋瓦·厚重含蓄', level: 'folk' }, { id: 'liuli', name: '琉璃黄', hex: '#D4A843', meaning: '宫城琉璃·明亮珍贵', level: 'royal' }, { id: 'yuebai', name: '月白', hex: '#F0EDE5', meaning: '月色如瓷·清雅素净', level: 'folk' }, { id: 'mohei', name: '墨黑', hex: '#2D2D2D', meaning: '浓墨重彩·沉稳庄重', level: 'folk' }, { id: 'jin', name: '鎏金', hex: '#C5A355', meaning: '金碧辉煌·尊贵荣耀', level: 'royal' }, { id: 'yin', name: '铸银', hex: '#B0B0B0', meaning: '银光素雅·内敛含蓄', level: 'royal' }];
        var elements = [{ id: 'cloud_base', name: '云纹底座', desc: '传统祥云纹托底，寓意神兽腾云驾雾' }, { id: 'map_base', name: '中轴线地图底座', desc: '以中轴线地图为底座，标注从永定门到钟鼓楼的完整路线' }, { id: 'km_marker', name: '零公里标志', desc: '正阳门旁的"中国公路零公里"标志，象征北京的中心点' }, { id: 'plaque', name: '正阳门牌匾', desc: '"正阳门"三字门匾，内城正门的标志' }, { id: 'archaeology_tag', name: '考古铭牌', desc: '标注神兽出土位置和年代，如"正阳桥遗址·明代"' }, { id: 'custom_tag', name: '个性化铭牌', desc: '写上自己的名字和创作寄语' }];
